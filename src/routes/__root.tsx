...
export const Route = createRootRouteWithContext<RouterContext>()({
  head: () => ({
    meta: [
      ...
      { title: "Dashboard · Pandus Maximus" },
      ...
      { name: "apple-mobile-web-app-title", content: "Pandus Maximus" },
      { name: "application-name", content: "Pandus Maximus" },
    ],
    links: [
