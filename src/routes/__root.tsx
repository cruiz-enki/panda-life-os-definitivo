...
export const Route = createRootRouteWithContext<RouterContext>()({
  head: () => ({
    meta: [
      ...
      { title: "Panda's LIFE OS — Tu sistema operativo personal" },
      { name: "description", content: "Sistema operativo personal gamificado: hábitos, aprendizajes y energía con recomendaciones diarias." },
      { name: "theme-color", content: "#0a1612" },
      { property: "og:title", content: "Panda's LIFE OS — Tu sistema operativo personal" },
      { property: "og:description", content: "Sistema operativo personal gamificado: hábitos, aprendizajes y energía con recomendaciones diarias." },
      { property: "og:type", content: "website" },
      { name: "twitter:title", content: "Panda's LIFE OS — Tu sistema operativo personal" },
      { name: "twitter:description", content: "Sistema operativo personal gamificado: hábitos, aprendizajes y energía con recomendaciones diarias." },
